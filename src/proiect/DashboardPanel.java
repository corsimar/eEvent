...
public class DashboardPanel extends MyPanel {
    ...
    public DashboardPanel() {
        ...
        for(int i = 0; i < boxLabel.length; i++) {
            ...
            boxTitle[i] = new MyLabel("", textColor, new Font("Monospaced", Font.BOLD, fontTitleSize), SwingConstants.CENTER, SwingConstants.CENTER);
            boxInfo[i] = new MyLabel("", textColor, new Font("Monospaced", Font.PLAIN, fontInputSize), SwingConstants.CENTER, SwingConstants.CENTER);
