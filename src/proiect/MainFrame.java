...
public class MainFrame extends MyFrame implements KeyListener {
    ...
    private void initTopBar() {
        ...
        maximizeBtn.addActionListener(buttonListener);
        ...
        minimizeBtn.addActionListener(buttonListener);
    ...
    void initMenuBar() {
        ...
        eventsBtn.addActionListener(buttonListener);
        ...
        changePassBtn.addActionListener(buttonListener);
        ...
        prefBtn.addActionListener(buttonListener);
        menuBar.add(prefBtn);
        ...
        disconnectBtn.addActionListener(buttonListener);
    ...
    void initAdminMenuBar() {
        ...
        panelBtn.addActionListener(buttonListener);
        ...
        addEventBtn.addActionListener(buttonListener);
        ...
        manageEventsBtn.addActionListener(buttonListener);
        ...
        admChangePassBtn.addActionListener(buttonListener);
        ...
        admDisconnectBtn.addActionListener(buttonListener);
