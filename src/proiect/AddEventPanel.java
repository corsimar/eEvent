...
public class AddEventPanel extends MyPanel {
    ...
    public AddEventPanel() {
        ...
        addColorBtn.addActionListener(buttonListener);
        add(addColorBtn);
        ...
        addDateBtn.addActionListener(buttonListener);
        add(addDateBtn);
        ...
        for(int i = 0; i < 2; i++) {
            ...
            spinnerOption[i].addActionListener(buttonListener);
            add(spinnerOption[i]);
        }
        ...
        confirmAddEventBtn.addActionListener(buttonListener);
